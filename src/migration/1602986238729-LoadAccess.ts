...
export class LoadAccess1602986238729 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`${start}'${process.env.ACCESS_TYPE_FORGOT_PASSWORD!}', 15, 'm', '${randomString()}')`);
    }
